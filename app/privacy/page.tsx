        ...
        en={
          <>
            ...
            <div className="mt-8 space-y-6 text-[15px] leading-relaxed">
              ...
              <section>
                <h2 className="text-base font-semibold text-slate-900">
                  Why MetricsField Requests Access to Google
                </h2>
                <p className="mt-2">
                  MetricsField is a reputation management platform for local
                  businesses. MetricsField requests read-only access to Google
                  Business Profile metrics (profile views, calls, direction
                  requests) strictly to display performance in a private
                  dashboard. We do not modify or publish content on your listing.
                </p>
              </section>
