...
export default function AutomatizacionResenas({
  ...
  return (
    <div className="rounded-2xl border border-white/60 bg-white/65 p-4 shadow-[0_8px_30px_-14px_rgba(17,17,17,0.14)] backdrop-blur-xl">
      ...
      {apiHabilitada ? (
        ...
        <p className="mt-1.5 flex items-start gap-2 rounded-lg bg-amber-50 px-3 py-2 text-xs text-amber-700">
          ...
          <span>
            ...
            automáticamente (es una revisión aparte que pidió MetricsField, no depende de vos).
