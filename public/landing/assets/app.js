...
(function () {
    ...
    sections: [
      {
        ...
        still: '/landing/assets/img/beat-local.webp',
        clip: '/landing/assets/vid/local.mp4', clipMobile: '/landing/assets/vid/local-m.mp4',
      ...
      },
      {
        ...
        still: '/landing/assets/img/beat-gesto.webp',
        clip: '/landing/assets/vid/gesto.mp4', clipMobile: '/landing/assets/vid/gesto-m.mp4',
      ...
      },
      {
        ...
        still: '/landing/assets/img/beat-dato.webp',
        clip: '/landing/assets/vid/dato.mp4', clipMobile: '/landing/assets/vid/dato-m.mp4',
        scroll: 1.2,
      ...
      },
      {
        ...
        still: '/landing/assets/img/beat-panel.webp',
        clip: '/landing/assets/vid/panel.mp4', clipMobile: '/landing/assets/vid/panel-m.mp4',
        reveal: true,
  ...
  function onScroll() {
    ...
    if (solid !== navSolid) {
      navSolid = solid;
      if (navMark) navMark.src = '/landing/assets/img/logo-icon-' + (solid ? 'dark' : 'light') + '.webp';
    }
